...
class SensorDataProcess
{
    ...
    {
        if ($humidity > 100) {
            throw new HumidityException("Humidity value should not exceed 100");
        }

        if ($humidity < 0) {
            throw new HumidityException("Humidity value must be positive");
        }

        if ($gasLevel < 0) {
            throw new GasException("Gas level value must be positive");
        }
